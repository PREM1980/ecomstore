                ...
                if table1_null is False and table2_null is False:
                    ...
                    for eachcol in self.table_qry_schema:
                            ...
                            if self.debug:
                                ...
                                print 'getattr(self.table_row_dict,eachcol)=', getattr(self.table_row_dict,eachcol)
                                print 'getattr(self.table_row_dict,tab2col)=', getattr(self.table_row_dict,tab2col)
                                print 'type_table_row_dict[eachcol]=', type(getattr(self.table_row_dict,eachcol))
                                print 'type_table_row_dict[tab2col]=', type(getattr(self.table_row_dict,tab2col))
...
#         if self.error_count[eachcol] < self.num_of_errors:
    ...
    def _write_error_dict(self,eachcol,tab2col):
        if self.debug:
            ...
            print 'eachcol=', eachcol
            print 'tab2col=', tab2col
            print 'self.key_values=',self.key_values
