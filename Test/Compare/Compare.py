...
#                                     result = self.table2_row_dict[key] - self.table1_row_dict[key]
    ...
    def _check_types(self,key):
            ...
            if ((self.table1_Schema_type[key][0] == 'VARCHAR' and self.table2_Schema_type[key][0] == 'CHAR') or         \
                (self.table1_Schema_type[key][0] == 'CHAR' and self.table2_Schema_type[key][0] == 'VARCHAR')): 
                numeric = False
                compare = True        
            elif ((self.table1_Schema_type[key][0] == 'DECIMAL' and self.table2_Schema_type[key][0] == 'FLOAT') or       \
                  (self.table1_Schema_type[key][0] == 'FLOAT' and self.table2_Schema_type[key][0] == 'DECIMAL') or
...
#         print self.error_lists
        ...
        for x in range(len(error_lists)):
                ...
                key = ''.join(str(error_lists[x]['KEY']))                    
                self.c.drawString(80, self.startval - (self._incr_val() * self.linediff), key)        
    ...
    def _write_page1_summary(self):
        ...
        self.c.drawString(200, self.startval,               "The COMPARE Procedure Report-File Compare")
...
#     x = Compare(TableNm1='Employee1',TableNm2='Employee2',Keyfields=['EMP_NO','EMP_FNAME'],db='CSSC',num_of_errors=50,tolerance=0)
